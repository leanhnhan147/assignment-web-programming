...
<div class="form_survey main">

    <form action="<%=request.getContextPath()%>/assignment/4/survey" method="post">
        <img src="<%=request.getContextPath() %>/assets/images/assignment4/murachlogo.jpg" alt="logo" />
        <h1>Survey</h1>
