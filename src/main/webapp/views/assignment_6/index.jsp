...
<div class="main">
  ...
  <p>
    <a href="<%=request.getContextPath()%>/assignment/6/download?action=checkUser&amp;productCode=8601">
      86 (the band) - True Life Songs and Pictures
    </a><br>

    <a href="<%=request.getContextPath()%>/assignment/6/download?action=checkUser&amp;productCode=pf01">
      Paddlefoot - The First CD
    </a><br>

    <a href="<%=request.getContextPath()%>/assignment/6/download?action=checkUser&amp;productCode=pf02">
      Paddlefoot - The Second CD
    </a><br>

    <a href="<%=request.getContextPath()%>/assignment/6/download?action=checkUser&amp;productCode=jr01">
