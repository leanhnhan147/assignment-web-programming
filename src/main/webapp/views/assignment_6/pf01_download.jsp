...
<div class="main">
  ...
  <table>
    ...
    <tr>
      <td>64 Corvair</td>
      <td><a href="<%=request.getContextPath()%>/musicStore/sound/${productCode}/corvair.mp3">MP3</a></td>
    </tr>
    <tr>
      <td>Whiskey Before Breakfast</td>
      <td><a href="<%=request.getContextPath()%>/musicStore/sound/${productCode}/whiskey.mp3">MP3</a></td>
    </tr>
  </table>
